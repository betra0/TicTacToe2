...
function MenuPage(){
    ...
    <main className="bg-gray-900 w-screen h-screen  flex items-center flex-col text-white">
        ...
        <Link className="bg-gray-800 w-full rounded-lg py-1 text-xl hover:bg-gray-700 transform hover:scale-110 duration-200 transition-transform active:scale-90" to="/">Local</Link>
